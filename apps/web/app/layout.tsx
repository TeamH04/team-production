...
export const metadata: Metadata = {
  title: 'Kuguri - 次に通いたくなるお店を見つけよう',
  description: 'カフェからレストラン、バーまで、カテゴリとキーワードで探せるお店検索サービス',
};
...
export default function RootLayout({
  ...
  return (
    <html lang='ja' style={themeStyle}>
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${kiwiMaru.variable} pb-14 antialiased md:pb-0`}
      >
