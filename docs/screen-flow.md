...
| **マイページ**                     | プロフィール編集・お気に入り・投稿履歴などを表示。お気に入り/レビュー/いいねの概要と履歴画面への導線を提供。                                                                                       |
| **お気に入り一覧**                 | ユーザーがブックマークした店舗の一覧。                                                                                                                                                             |
| **店舗詳細**                       | 店舗の基本情報・写真・レビュー・SNSリンクを表示。レビューは新しい順/高評価順で切り替え、いいね数も確認できる。                                                                                     |
| **レビュー履歴**                   | 「お気に入り」「レビュー履歴」「いいね」をタブで切り替えて確認できる一覧画面。                                                                                                                     |
| **レビュー投稿**                   | 評価・コメント・写真（複数）を投稿できる画面。メニュー選択は任意で、画像とメニューの紐づけは行わない。                                                                                             |
